...
function sidebar_path() {
  return new SageWrapping('components/sidebar.php');
}
...
class SageWrapping {
  ...
  public function __construct($template = 'base.php') {
    ...
    if (self::$base) {
      ...
      array_unshift($this->components, sprintf($str . '-%s.php', self::$base));
    }
  }

  public function __toString() {
    $this->components = apply_filters('sage/wrap_' . $this->slug, $this->components);
    return locate_template($this->components);
  }
